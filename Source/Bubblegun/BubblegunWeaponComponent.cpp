...
UBubblegunWeaponComponent::UBubblegunWeaponComponent()
{
...
bool UBubblegunWeaponComponent::AttachWeapon(ABubblegunCharacter* TargetCharacter, FName SocketName)
{
	...
	if (Character == nullptr || Character->GetInstanceComponents().FindItemByClass<UBubblegunWeaponComponent>())
	{
		return false;
	}
	...
	if (APlayerController* PlayerController = Cast<APlayerController>(Character->GetController()))
	{
		...
		{
			// Fire
			EnhancedInputComponent->BindAction(FireAction, ETriggerEvent::Triggered, this, &UBubblegunWeaponComponent::Fire);
		}
	}
...
void UBubblegunWeaponComponent::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
